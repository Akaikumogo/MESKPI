  ...
  const columns: ColumnsType<ClassDto> = [
    {
      ...
      render: (record: ClassDto) => (
        ...
        >
          <div className="w-12 h-12 bg-[#2e36cc] rounded-lg flex items-center justify-center">
...

    {
      ...
      render: (record: ClassDto) => (
        <div className="text-center">
          <div className="text-lg font-semibold text-[#2e36cc]">
  ...
  return (
    <div className="p-6 space-y-6 min-h-full bg-slate-50 dark:bg-[#0f0f0f]">
      ...
      <Modal
        ...
        okButtonProps={{
          style: { backgroundColor: '#2e36cc', border: 'none' }
        }}
        width={700}
      >
